...
<ul class="velocity-setup-step-list">
    <li>
        <img src="{{ \Illuminate\Support\Facades\Storage::url(core()->getConfigData('marketplace.settings.velocity.setup_icon_1')) }}"/>

        <span>{{ __('marketplace::app.shop.marketplace.setup-1') }}</span>
    </li>

    <li>
        <img src="{{ \Illuminate\Support\Facades\Storage::url(core()->getConfigData('marketplace.settings.velocity.setup_icon_2')) }}"/>

        <span>{{ __('marketplace::app.shop.marketplace.setup-2') }}</span>
    </li>

    <li>
        <img src="{{ \Illuminate\Support\Facades\Storage::url(core()->getConfigData('marketplace.settings.velocity.setup_icon_3')) }}"/>

        <span>{{ __('marketplace::app.shop.marketplace.setup-3') }}</span>
    </li>

    <li>
        <img src="{{ \Illuminate\Support\Facades\Storage::url(core()->getConfigData('marketplace.settings.velocity.setup_icon_4')) }}"/>

        <span>{{ __('marketplace::app.shop.marketplace.setup-4') }}</span>
    </li>

    <li>
        <img src="{{ \Illuminate\Support\Facades\Storage::url(core()->getConfigData('marketplace.settings.velocity.setup_icon_5')) }}"/>
